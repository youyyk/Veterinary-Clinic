...
public class AccountService {
    ...
    public List<Account> getAllNotIncludeNowAccount(UUID accId) {
        return accountRepository.getAllNotIncludeNowAccount(accId, Sort.by(Sort.Direction.ASC, "firstName"));
    }
