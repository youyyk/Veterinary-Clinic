...
public class VeterinaryClinicApplication {
	...
	public CommandLineRunner mappingDemo(PetService petService,
        ...
        petService.create(pet);
        pet = new Pet("มินิ","เมีย",GlobalService.convertStringToDate("2015/12/09"),false,"สุนัข","ชิวาวา");
        petService.create(pet);
        ...
        //------------- Appointment --------------
        pet = new Pet("แทมมี่","ผู้",GlobalService.convertStringToDate("2021/08/12"),false,"แมว","เปอร์เซีย");
        petService.create(pet);

        Appointment appointment = new Appointment(pet,GlobalService.convertStringToDate("2022/12/27"),"อาเจียนและท้องเสีย");
        appointmentService.create(appointment);

        appointment = new Appointment(pet,GlobalService.convertStringToDate("2023/02/08"),"ฉีดวัคซีน");
        appointmentService.create(appointment);
